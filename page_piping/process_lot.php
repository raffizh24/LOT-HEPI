...
$lot = mysqli_fetch_all(
    mysqli_query($conn, "SELECT * FROM piping_lot WHERE coupon LIKE '{$part_code}%' AND status='Used'"),
    MYSQLI_ASSOC
);
...
$stok = mysqli_fetch_assoc(mysqli_query(
    $conn,
    "SELECT qty FROM piping_stok WHERE part_code='{$part_code}'"
))['qty'] ?? 0;
                ...
                <div class="list-group my-3">
                    <a class="list-group-item list-group-item-action" aria-current="true">
                        <div class="d-flex w-100 justify-content-between">
                            <div style="max-height: 290px; overflow-y: auto; width: 100%;">
